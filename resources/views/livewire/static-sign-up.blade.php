                    ...
                    <div class="container">
                        <div class="row">
                            <div
                                ...
                                <div class="position-relative bg-gradient-warning dynamic-config-gradient h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center"
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="text-center">
                                                <button type="submit"
                                                    class="btn btn-lg bg-gradient-warning dynamic-config-btn btn-lg w-100 mt-4 mb-0">Sign
                                                    Up</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                        <p class="mb-2 text-sm mx-auto">
                                            ...
                                            <a href="{{ route('static-sign-in') }}"
                                                class="text-warning text-gradient dynamic-config-text font-weight-bold">Sign in</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
